    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CloudStorageAccount storageAccount 
                = CloudStorageAccount.Parse(@"DefaultEndpointsProtocol=https;AccountName=shivstorage;AccountKey=3kaZpF7d3rkam813Yf9+G+a2BkU1Lgd52QXM/vZEudKuMunxv6Ug/Wi3kzfTkaKJk/GzrRXFdxpwaKM48NaiwA==;EndpointSuffix=core.windows.net");
            // Step 2 :-- Table client
